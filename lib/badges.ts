...
> = {
  ...
  AUTHOR_STATUS: {
    icon: Feather,
    label: 'Author',
    description: 'Earned author status through readership',
  },
  ...
  CHALLENGE_ENTERED: {
    icon: Swords,
    label: 'Challenger',
    description: 'Entered your first writing challenge',
  },
  BINGO_COMPLETE: {
    icon: Target,
    label: 'Bingo!',
    description: 'Completed a bingo line on a horror bingo card',
  },
};
