...
export const THEMES = {
  ...
  ghost: {
    ...
    heroRadial:
      'bg-[radial-gradient(ellipse_80%_60%_at_20%_40%,rgba(59,130,246,0.18),transparent)]',
  ...
  void: {
    ...
    heroRadial:
      'bg-[radial-gradient(ellipse_80%_60%_at_20%_40%,rgba(147,51,234,0.18),transparent)]',
  ...
  toxic: {
    ...
    heroRadial:
      'bg-[radial-gradient(ellipse_80%_60%_at_20%_40%,rgba(132,204,22,0.15),transparent)]',
