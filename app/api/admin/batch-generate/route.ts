...
const CATEGORY_IMAGES: Record<string, string[]> = {
  ...
  'short-nightmares':    ['dark room shadows','nightmare shadow','dark corner shadow','dark night horror'],
  ...
  'fantasy':             ['dark forest','dark forest fog','deep forest dark','creepy woods'],
  ...
  'psychological':       ['dark mind horror','mirror dark','psychological dark','shadow face'],
