...
export default function WarningsClient({
  ...
  suspendedUsers: initialSuspended,
}: {
  warnings: Warning[];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <select
              value={action}
              onChange={(e) => setAction(e.target.value as 'warn' | 'suspend' | 'ban')}
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
          ...
          {bannedUsers.length === 0 ? (
            <p className="text-gray-600 text-sm">No banned users.</p>
          ) : (
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
        ...
        {warnings.length === 0 ? (
          <p className="text-gray-600 text-sm">No warnings issued yet.</p>
        ) : (
              ...
              <div key={w.id} className="border-b border-gray-800 pb-3 last:border-0">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-xs text-gray-500">
                    {new Date(w.issuedAt).toLocaleDateString()} · by {w.admin.username}
                  </span>
                </div>
