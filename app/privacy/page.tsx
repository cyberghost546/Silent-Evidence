        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-gray-300 leading-relaxed">
          <section className="border border-amber-900/40 bg-amber-950/20 rounded-xl p-4">
            <p className="text-amber-300/90 text-xs">
              <strong>Operator details required.</strong> The sections below marked [square
              brackets] must be completed with the legal entity that runs this site before
              publication. A privacy policy that does not identify its data controller does not
              satisfy GDPR Art. 13(1)(a).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              responsible for your personal data is <strong>[legal entity name]</strong>, registered
              at <strong>[registered address]</strong>.
            </p>
            <p className="mt-3">
              For any privacy question, or to exercise the rights described in section 8, contact{' '}
              <strong>[privacy@yourdomain]</strong>. We aim to respond within 30 days, which is the
              deadline set by GDPR Art. 12(3).
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-400">
              ...
              <li>
                Your password, stored only as a one-way bcrypt hash — we never see the plain text
              </li>
              <li>
                Your date of birth, which we convert into an age band used to restrict mature
                content
              </li>
              <li>Optional profile details: avatar, bio, website, preferred themes and moods</li>
              <li>
                Stories, chapters, comments, forum posts, direct messages and group posts you write
              </li>
            </ul>

            <p className="font-semibold text-gray-200 mt-4">
              Information generated as you use the site
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-400">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-400">
              <li>
                Your IP address and browser user-agent. These are used for security (rate limiting,
                detecting suspicious logins) and are recorded in a login log alongside an
                approximate location — see section 5.
              </li>
              <li>
                A record of your cookie choice, stored with a <em>truncated</em> IP address (the
                last octet is removed) rather than the full one.
              </li>
              <li>Basic usage events used to understand which parts of the site people reach.</li>
            </ul>

            <p className="mt-3">
              If you sign in with Google or Microsoft, we receive your name, email address and
              profile picture from that provider. We never receive your password for those accounts.
            </p>
          </section>
          ...
          <section>
            ...
            <p>Under GDPR Art. 6 we must have a lawful basis for each use. Ours are:</p>
            <div className="overflow-x-auto mt-3">
              <table className="w-full text-xs text-left text-gray-400 border border-gray-800 rounded-lg">
                ...
                <tbody>
                  {[
                    [
                      'Create and run your account; publish what you post',
                      'Performance of a contract',
                    ],
                    ['Keep you logged in via a session cookie', 'Strictly necessary — contract'],
                    [
                      'Take payment for stories, bundles, tips and subscriptions',
                      'Performance of a contract',
                    ],
                    ['Send account and security emails', 'Performance of a contract'],
                    [
                      'Restrict mature content by age band',
                      'Legal obligation / legitimate interest',
                    ],
                    [
                      'Rate limiting, abuse detection, login logging',
                      'Legitimate interest in site security',
                    ],
                    [
                      'Moderate content for hate speech and abuse',
          ...
          <section>
            ...
            <p>
              We use the following strictly necessary cookies. These cannot be switched off, because
              the site cannot function without them:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-400">
              <li>
                <code>userId</code> and <code>userId_sig</code> — identify your session and prove it
                has not been tampered with. HttpOnly, SameSite=Lax, 7-day expiry.
              </li>
              <li>
                <code>csrf_token</code> — protects forms against cross-site request forgery.
              </li>
            </ul>
            <p className="mt-3">
              We also store a small amount of data in your browser&apos;s local storage, which never
              leaves your device:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-400">
            ...
            <p className="mt-3">
              ...
              <strong>Cookie settings</strong> link in the footer of every page. Withdrawing is as
              easy as giving consent, as required by GDPR Art. 7(3).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We use the following processors. Each receives only what it needs to do its job, and
              ...
              <table className="w-full text-xs text-left text-gray-400 border border-gray-800 rounded-lg">
                ...
                <tbody>
                  {[
                    [
                      'Stripe',
                      'Payment and subscription details. Card numbers go directly to Stripe and are never stored on our servers.',
                    ],
                    [
                      'Anthropic (Claude)',
                      'Story and comment text, for automated moderation, scare-scoring, translation and writing assistance.',
                    ],
                    ...
                    [
                      'Email provider (SMTP)',
                      'Your email address and message content, to deliver account and notification emails.',
                    ],
                    [
                      'Geolocation provider',
                      'Your IP address, to derive an approximate login location for security alerts. Only used if this optional feature is enabled, and only over an encrypted connection.',
                    ],
                  ].map(([name, what]) => (
            ...
            <p className="mt-3">
              Several of these providers are based in the United States, so using this site involves
              transferring your data outside the UK and EEA. Those transfers rely on the
              providers&apos; standard contractual clauses and, where applicable, their
              certification under the EU–US Data Privacy Framework.
            </p>
            <p className="mt-3">
              We may also disclose data where we are legally required to, or where it is necessary
              to investigate abuse or protect the safety of our users.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              When you publish a story or post a comment, its text is sent to an AI service to check
              for hate speech, harassment and threats. Content flagged by that check is refused at
              the point of posting.
            </p>
            <p className="mt-3">
              This is an automated decision that affects whether your content appears. If your post
              is blocked and you believe that is wrong, contact us using the details in section 1
              and a human will review it — GDPR Art. 22 gives you the right to that human review.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              This site publishes horror fiction, much of which is not suitable for children. We ask
              for your date of birth and use it to restrict access to mature content.
            </p>
            <p className="mt-3">
              We do not knowingly collect personal data from children under 13. If you believe a
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-400">
              ...
              <li>
                <strong className="text-gray-200">Rectification</strong> — correct your details from
                the Settings page.
              </li>
              <li>
              ...
              <li>
                <strong className="text-gray-200">Withdraw consent</strong> — for cookies via the
                footer link, and for emails via the unsubscribe link in any email or your
                notification settings.
              </li>
              <li>
                <strong className="text-gray-200">Object or restrict</strong> — ask us to stop or
                limit a use that relies on legitimate interest.
              </li>
              <li>
                <strong className="text-gray-200">Complain</strong> — to your local data protection
                authority. In the UK that is the Information Commissioner&apos;s Office
                (ico.org.uk).
              </li>
            </ul>
            <p className="mt-3">
              If you are in California, you additionally have the right to know what we collect, to
              delete it, and to opt out of sale or sharing. We do not sell or share personal
              information as those terms are defined by the CCPA/CPRA, so there is nothing to opt
              out of — but the access and deletion controls above serve those requests.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-400">
              ...
              <li>
                Payment records: retained as long as tax and accounting law requires, typically 6–7
                years.
              </li>
            </ul>
            <p className="mt-3">
              These periods are enforced automatically: a scheduled job runs daily and permanently
              deletes records that have passed their retention window.
            </p>
            <p className="mt-3">
              When you delete your account, your profile, stories, comments and reading history are
          ...
          <section>
            ...
            <p>
              Passwords are hashed with bcrypt. Sessions are signed so they cannot be forged, and
              optional two-factor authentication is available. Requests are rate limited, and you
              can end every active session from Settings if you think your account has been
              compromised. No system is perfectly secure, but if a breach affects your rights we
              will notify you and the relevant regulator as the law requires.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Privacy questions and rights requests: <strong>[privacy@yourdomain]</strong>. You can
