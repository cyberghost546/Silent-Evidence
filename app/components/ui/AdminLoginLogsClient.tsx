  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: 'Total (all pages)', value: totalCount,    color: 'text-gray-300',  bg: 'bg-gray-800' },
          { label: 'Success (this page)', value: successCount, color: 'text-green-400', bg: 'bg-green-900/20' },
          { label: 'Failed (this page)',  value: failCount,    color: 'text-red-400',   bg: 'bg-red-900/20' },
        ].map(s => (
          <div key={s.label} className={`${s.bg} border border-gray-800 rounded-xl p-4 text-center`}>
