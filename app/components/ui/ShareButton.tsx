...
export default function ShareButton({ title }: { title: string }) {
  ...
  const shareReddit = () => {
    window.open(
      `https://reddit.com/submit?title=${encodeURIComponent(title)}&url=${encodeURIComponent(window.location.href)}`,
      '_blank'
    );
  };
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        onClick={shareX}
        title="Share on X"
        className="p-2 rounded-lg border border-gray-700 bg-gray-800 text-gray-400 hover:text-white hover:border-gray-500 transition"
      >
      ...
      <button
        ...
        className="p-2 rounded-lg border border-gray-700 bg-gray-800 text-gray-400 hover:text-[#25D366] hover:border-gray-500 transition"
      >
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <button
        ...
        className="p-2 rounded-lg border border-gray-700 bg-gray-800 text-gray-400 hover:text-[#ff4500] hover:border-gray-500 transition"
      >
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
