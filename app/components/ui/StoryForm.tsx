...
export default function StoryForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const priceCents = Number.isFinite(parsedPrice) && parsedPrice > 0 ? parsedPrice : null;
      ...
      <form onSubmit={handleSubmit} className="space-y-6" suppressHydrationWarning>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1.5">
            ...
            <span className="text-gray-500 font-normal">
              (what language is your story written in?)
            </span>
          </label>
          <select
            value={language}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1.5">
            Video URL{' '}
            <span className="text-gray-500 font-normal">
              (optional — YouTube link or direct .mp4)
            </span>
          </label>
          <input
            type="url"
          ...
          <p className="text-xs text-gray-600 mt-1">
            Paste a YouTube link and readers will see the video embedded on your story page.
          </p>
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1.5">
            Story Series <span className="text-gray-500 font-normal">(optional)</span>
          </label>
          ...
          <p className="text-xs text-gray-600 mt-1">
            ...
            <a href="/series/new" className="text-red-400 hover:text-red-300 transition">
              Create one first →
            </a>
          </p>
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1.5">
            Location{' '}
            <span className="text-gray-500 font-normal">
              (optional — pins story on the Horror Map)
            </span>
          </label>
          <input
            value={locationName}
          ...
          <p className="text-xs text-gray-600 mt-1">
            Find coordinates at <span className="text-gray-400">latlong.net</span>
          </p>
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1.5">
            Story Mood <span className="text-gray-500 font-normal">(optional)</span>
          </label>
          <select
            value={mood}
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {(
              ...
              >
                <Circle
                  className={`w-3.5 h-3.5 mb-1 ${r.tone}`}
                  strokeWidth={3}
                  aria-hidden="true"
                />
          ...
          <div className="rounded-xl border border-amber-500/25 bg-amber-500/5 p-4 flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">
                Charge for this story, publish it members-only, set an early-access window, or
                attach audio narration — all part of Author Pro.
              </p>
            </div>
            <a
              href="/author-pro"
        ...
        {isAuthorPro && (
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-1.5">
              Audio Narration URL{' '}
              <span className="text-gray-500 font-normal">
                (optional — MP3 link for premium listeners)
              </span>
            </label>
            <input
              type="url"
            ...
            />
            <p className="text-xs text-gray-600 mt-1">
              Only premium members will be able to play this audio.
            </p>
          </div>
        )}
          ...
          <div className="rounded-xl border border-yellow-500/20 bg-yellow-500/5 p-4 space-y-4">
            ...
            <div>
              <label htmlFor="storyPrice" className="block text-sm font-medium text-gray-300 mb-1">
                Price{' '}
                <span className="text-gray-500 font-normal">
                  (optional — leave blank to publish free)
                </span>
              </label>
              ...
              <p className="text-xs text-gray-600 mt-1">
                Readers pay once for permanent access. Premium members and anyone who already bought
                it are unaffected.
              </p>
            </div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  Only premium subscribers can read this story. It will never be made free.
                </p>
              </div>
              <button
                type="button"
              ...
              >
                <span
                  className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-all ${isPremiumOnly ? 'left-5' : 'left-0.5'}`}
                />
              </button>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-600 mt-1">
                Free users cannot read until this date passes. Leave blank for immediate public
                access.
              </p>
              {earlyAccessUntil && (
                <p className="text-xs text-yellow-400/70 mt-1">
                  Free readers unlocked on{' '}
                  {new Date(earlyAccessUntil).toLocaleDateString('en-US', {
                    weekday: 'long',
                    month: 'long',
                    day: 'numeric',
                    hour: '2-digit',
