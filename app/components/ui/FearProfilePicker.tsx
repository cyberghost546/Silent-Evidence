...
// Lets a user choose up to 3 horror moods as their "fear profile".
...
// All available anime moods with display info (value matches the DB enum)
const MOODS = [
...
// Main picker component — lets the user pick up to 3 anime vibes
export default function FearProfilePicker({ initialFearMoods }: Props) {
  ...
  const [selected, setSelected] = useState<string[]>(
    initialFearMoods ? initialFearMoods.split(',').filter(Boolean) : []
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        {/* Counter turns red when max is reached */}
