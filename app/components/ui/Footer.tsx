        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4 mt-5">
              <a href="https://x.com/silentevidence" target="_blank" rel="noopener noreferrer" aria-label="Twitter / X" className="text-gray-600 hover:text-white transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://reddit.com/r/silentevidence" target="_blank" rel="noopener noreferrer" aria-label="Reddit" className="text-gray-600 hover:text-white transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://discord.gg/silentevidence" target="_blank" rel="noopener noreferrer" aria-label="Discord" className="text-gray-600 hover:text-white transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-4">Navigate</h3>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {categories.map((cat) => (
                <li key={cat.slug}>
                  <Link href={`/category/${cat.slug}`} className="text-gray-500 hover:text-white transition">
                    {cat.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-4">Account</h3>
            <ul className="space-y-2.5 text-sm">
              {[
            ...
            <h3 className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-4 mt-7">Legal</h3>
            <ul className="space-y-2.5 text-sm">
              {[
