                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center">
                      <button
                        ...
                        disabled={loading === story.id}
                        className={`text-lg transition disabled:opacity-40 ${story.featured ? 'text-yellow-400' : 'text-gray-600 hover:text-yellow-400'}`}
                      >
                        ★
                      </button>
                    </td>
                    ...
                    <td className="px-4 py-3 text-center">
                      <button
                        onClick={() => setCreepyOfMonth(story.id)}
                        disabled={loading === story.id}
                        className={`text-lg transition disabled:opacity-40 ${story.creepyOfMonth ? 'text-red-400' : 'text-gray-600 hover:text-red-400'}`}
                      ></button>
                    </td>
