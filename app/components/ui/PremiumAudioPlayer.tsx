  ...
  if (!hasPremium || !audioUrl) {
    return (
      <div className="mt-8 rounded-2xl border border-yellow-500/20 bg-yellow-500/5 p-5 flex items-center gap-4">
        <div className="w-10 h-10 rounded-full bg-yellow-500/10 border border-yellow-500/20 flex items-center justify-center text-xl shrink-0"></div>
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-white">Audio Narration Available</p>
          <p className="text-xs text-gray-500 mt-0.5">
            Premium members can listen to a full narration of this story.
          </p>
        </div>
        <a
          href="/premium"
  ...
  return (
    <div className="mt-8 rounded-2xl border border-purple-500/20 bg-purple-500/5 p-5">
      ...
      <div className="flex items-center gap-3 mb-3">
        <div className="w-8 h-8 rounded-full bg-purple-500/20 flex items-center justify-center text-base shrink-0"></div>
        <div className="flex-1 min-w-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <p className="text-xs text-gray-500">{playing ? 'Now playing…' : 'Click to listen'}</p>
      </div>
    </div>
  );
}
