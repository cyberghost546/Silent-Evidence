    ...
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      {!isLoggedIn && (
        <div className="text-center py-20">
          ...
          <Link href="/login" className="text-sm text-red-400 hover:text-red-300 transition">
            Sign in →
          </Link>
        </div>
      )}
      ...
      {isLoggedIn && !loading && isEmpty && (
        <div className="text-center py-20">
          ...
          <Link
            href="/search"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-xl text-sm transition"
          >
            Discover Authors
          </Link>
        </div>
      ...
      {isLoggedIn && !loading && stories.length === 0 && !isEmpty && (
        <div className="text-center py-20">
          <p className="text-gray-500 text-sm">
            The authors you follow haven&apos;t published anything yet.
          </p>
        </div>
      )}
