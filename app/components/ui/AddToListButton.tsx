          ...
          <div className="max-h-52 overflow-y-auto">
            ...
            {lists.map((list) => (
              <button
                ...
                disabled={loading || added.has(list.id)}
              ...
              >
                ...
                <span
                  className={`text-xs ml-2 flex-shrink-0 ${added.has(list.id) ? 'text-green-400' : 'text-gray-600'}`}
                >
            ...
            {creating ? (
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-3 py-1.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-red-600"
                />
                <button
