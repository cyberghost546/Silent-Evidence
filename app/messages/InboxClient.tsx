        ...
        const updated = prev.map((c) =>
          c.partner.id === data.senderId
            ? {
                ...
                unread: activePartner?.id === data.senderId ? 0 : c.unread + 1,
              }
            : c
        );
        return updated;
    ...
    <div className="flex h-[calc(100vh-57px)] bg-gray-950 overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {searchQuery.trim() ? (
            <div>
              {searching && <p className="text-xs text-gray-600 text-center py-6">Searching…</p>}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-baseline justify-between gap-1">
                          <p
                            className={`text-sm font-semibold truncate ${c.unread > 0 ? 'text-white' : 'text-gray-300'}`}
                          >
                            {c.partner.username}
                          </p>
