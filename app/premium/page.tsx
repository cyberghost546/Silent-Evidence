    ...
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <section className="relative py-20 px-4 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none select-none" aria-hidden="true">
          ...
          <span className="absolute top-6 left-1/2 -translate-x-1/2 text-[120px] opacity-5 leading-none"></span>
        </div>
        ...
        <p className="relative text-gray-400 text-lg max-w-xl mx-auto">
          Support the darkest storytellers on the web. Unlock every chilling tale, earn your elite
          badge, and terrorise the leaderboards.
        </p>
      </section>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">
                  All premium perks are unlocked for your account.
                </p>
              </div>
            </div>
      ...
      <section className="max-w-3xl mx-auto px-4 pb-20">
        ...
        <p className="text-center text-xs text-gray-600 mt-8">
          Cancel anytime. Payments processed securely by Stripe. No refunds on partial periods.
        </p>

        {/* Bottom skull decoration */}
        <div className="text-center mt-10 text-4xl opacity-10 select-none" aria-hidden="true"></div>
      </section>
