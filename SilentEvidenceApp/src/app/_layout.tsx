...
// Custom dark theme that matches the Anime Nexus anime aesthetic
// Overrides React Navigation's default dark colors with our brand palette
const AnimeDarkTheme = {
  ...DarkTheme,
  colors: {
    ...DarkTheme.colors,
...
// Custom light theme (rarely used — anime readers prefer dark mode)
const AnimeLightTheme = {
  ...DefaultTheme,
  colors: {
    ...DefaultTheme.colors,
...
export default function TabLayout() {
  ...
  return (
    <ThemeProvider value={colorScheme === 'dark' ? AnimeDarkTheme : AnimeLightTheme}>
