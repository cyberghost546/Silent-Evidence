// app/index.tsx
// Home screen — shows the 20 latest ALL-rated horror stories fetched from the
    ...
    <SafeAreaView style={styles.safe}>
      <FlatList
        ...
        ListHeaderComponent={
          <View>
            {/* App branding */}
            <Text style={styles.headerTitle}>Silent Evidence</Text>
...
const styles = StyleSheet.create({
  ...
  // "Silent Evidence" branding header
  headerTitle: {
    fontSize: 28,
    fontWeight: '800',
